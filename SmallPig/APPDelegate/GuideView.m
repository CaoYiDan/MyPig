...
- (id)initWithFrame:(CGRect)frame imageArray:(NSArray *)imageArray{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i = 0; i<imageArray.count; i++) {
            ...
            self.inputButton = [FactoryUI createButtonWithFrame:CGRectMake(SCREEN_W - 60, 20, 50,50) title:nil titleColor:nil imageName:@"2.fw_r2_c2" backgroundImageName:nil target:nil selector:nil];
