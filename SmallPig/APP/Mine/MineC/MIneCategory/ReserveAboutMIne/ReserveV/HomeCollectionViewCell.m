...
- (void)createUI{
    ...
    self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, self.imageView.frame.size.height-60, self.imageView.frame.size.width-20,25)];
...
- (void)refreshUI:(HomeModel *)model{
    ...
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:model.userAvatar] placeholderImage:[UIImage imageNamed:@"imagePlaceHold"]];
