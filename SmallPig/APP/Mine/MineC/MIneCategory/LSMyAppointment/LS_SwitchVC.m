...
-(void)ls_titleHeader{
    ...
    //底部滑动View
    UIImageView *silderImg = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_W/2-wid,titleHeight-4, wid, 3)];
...
- (void)switchController:(NSInteger)index
{
   ...
   vc.view.frame = CGRectMake( [UIScreen mainScreen].bounds.size.width* index, 0, [UIScreen mainScreen].bounds.size.width,SCREEN_H2-64-titleHeight);
