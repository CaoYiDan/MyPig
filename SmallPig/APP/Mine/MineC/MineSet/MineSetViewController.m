...
//    [topView addSubview:titleLabel];
    ...
    self.titleArr = @[@"账号设置",@"隐私设置",@"关于我们",@"帮助中心",@"意见反馈"];
    self.titleImageArr = @[@"lb_r1_c1",@"lb_r5_c1",@"lb_r9_c1",@"lb_r11_c1",@"lb_r13_c1"];
...
//    [[NSUserDefaults standardUserDefaults]setValue:@"0" forKey:@"userSubType"];
//    [[NSUserDefaults standardUserDefaults]setValue:nil forKey:@"tel"];
//    [[NSUserDefaults standardUserDefaults]setValue:@"quitBtn" forKey:@"quitBtn"];
//    [[NSUserDefaults standardUserDefaults]setValue:nil forKey:@"userCount"];
...
- (void)createTableView{
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 20, SCREEN_W, 300) style:UITableViewStylePlain];
