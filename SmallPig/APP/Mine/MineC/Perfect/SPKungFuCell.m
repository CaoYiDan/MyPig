...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.lable.layer.cornerRadius = 5.0f;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
   ...
   SPThirdLevelCell*cell = [collectionView dequeueReusableCellWithReuseIdentifier:SPThirdLevelCellID forIndexPath: indexPath];
    ...
    //collection 的背景颜色
    cell.baseColor = [SPCommon colorWithHexString:model3.bgColor];;
    return cell;
}
...
//    self.lable.textColor = [SPCommon colorWithHexString:model.fontColor];
//    self.lable.backgroundColor =[SPCommon colorWithHexString:model.bgColor];
