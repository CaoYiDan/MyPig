...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.chooseView loadWithCode:nil withAllArray:model1.subProperties haveChosedArr:model1.thirdLevelArr headerTitle:@"标签"];
    WeakSelf;
...
-(UITableView *)tableView{
    if (!_tableView ) {
        _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0,headerHeight, SCREEN_W, SCREEN_H2-headerHeight) style:UITableViewStylePlain];
