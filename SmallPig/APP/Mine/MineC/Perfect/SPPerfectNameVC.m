...
-(void)createUI{
    ...
    UIImageView *leftImg = [[UIImageView alloc]initWithFrame:CGRectMake(20, 100, 50, 70)];
    [leftImg setImage:[UIImage imageNamed:@"grxx4_pic2"]];
    [self.view addSubview:leftImg];
    
    //Form
    UITextField *formTextFiled = [[UITextField alloc]initWithFrame:CGRectMake(SCREEN_W-wid-30, 150-height, wid , height)];
    formTextFiled.placeholder = @"Form";
...
//    _nameTextFiled = nameTextFiled;
    ...
    oftenTextFiled.placeholder = @"Often";
    ...
    if (!isEmptyString(userDict[@"nickName"])) {
