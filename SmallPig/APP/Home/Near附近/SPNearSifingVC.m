...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.imageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"n_%ld",(long)indexPath.row]]];
        ...
        if (indexPath.row==1) {
            ...
            cell.detailLabel.text = [self getLevelString];
...
-(UITableView *)tableView{
    if (!_tableView ) {
        _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0,64, SCREEN_W, SCREEN_H2-49) style:UITableViewStyleGrouped];
...
-(UIButton *)siftingBtn{
    UIButton *sifting = [[UIButton alloc]initWithFrame:CGRectMake(40, SCREEN_H2-55, SCREEN_W-80, 40)];
...
-(void)sifting{
    ...
    NSLog(@"%@",locationDic);
    [dict setObject:locationDic forKey:@"location"];
