...
#pragma  mark 关闭按钮
-(UIButton *)shatBtn {
    UIButton *shat = [[UIButton alloc]initWithFrame:CGRectMake(0, 0,300,40)];
...
-(UIView *)baseView{
    UIView *base = [[UIView alloc]initWithFrame:CGRectMake((SCREEN_W-tabWid*2)/2,SCREEN_H/2-170, tabWid*2,340+40)];
    base.layer.cornerRadius = 5;
    base.clipsToBounds= YES;
    base.backgroundColor = MyBlueColor;
...
-(UITableView *)levelTab1{
    if (!_levelTab1 ) {
        ...
        _levelTab1 = [[UITableView alloc]initWithFrame:CGRectMake(0, 40,tabWid,300) style:UITableViewStyleGrouped];
...
-(UITableView *)levelTab2{
    if (!_levelTab2 ) {
        _levelTab2 = [[UITableView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.levelTab1.frame)+1,40, tabWid, 300)style:UITableViewStyleGrouped];
...
-(UIButton *)confirmBtn{
    UIButton *confirm = [[UIButton alloc]initWithFrame:CGRectMake(0, 340,tabWid*2, 40)];
    [confirm setTitle:@"确认" forState:0];
